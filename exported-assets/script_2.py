...
import os
os.makedirs('solana_discovery', exist_ok=True)
...
with open('solana_discovery/web_server.py', 'w') as f:
    f.write(web_server_cloud)

with open('solana_discovery/__init__.py', 'w') as f:
    f.write('')

print("✅ Created cloud-ready web_server.py")
